...
if flags.valNorStop == 1
    ...
    nr_children_facing_extra_heatwave_Breidablikk_2024(7,1) = nansum(nr_children_facing_extra_heatwave_Breidablikk_2024(1:6,1))
    nr_children_facing_extra_heatwave_Breidablikk_2025(7,1) = nansum(nr_children_facing_extra_heatwave_Breidablikk_2025(1:6,1))
    nr_children_facing_extra_heatwave_Breidablikk_tot( 7,1) = nansum(nr_children_facing_extra_heatwave_Breidablikk_tot( 1:6,1))
