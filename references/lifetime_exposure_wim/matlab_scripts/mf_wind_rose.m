...
h(1)=text(-g-ri, 0,'WEST', 'Fontsize', 40, 'Fontweight', 'Bold', 'VerticalAlignment','top',   'HorizontalAlignment','left', args{:});
h(2)=text( g+ri, 0,'EAST', 'Fontsize', 40,'Fontweight', 'Bold', 'VerticalAlignment','top',   'HorizontalAlignment','right',args{:});
h(3)=text( 0,-g-ri,'SOUTH', 'Fontsize', 40,'Fontweight', 'Bold','VerticalAlignment','bottom','HorizontalAlignment','left', args{:});
h(4)=text( 0, g+ri,'NORTH', 'Fontsize', 40,'Fontweight', 'Bold','VerticalAlignment','top',   'HorizontalAlignment','left', args{:});
handles=[handles h];
