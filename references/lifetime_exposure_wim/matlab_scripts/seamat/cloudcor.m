...
%  not clear which parametrization is best (see Fung et al, Rev. of Geophys.
%  and Space Phys, 22, 177-193, 1984). 
%
...
%        = 'bunker',lat : Bunker 91976) N Atlantic.
%
%
% INPUT:   optns: see above for details
%          lat  : latitude (scalar) - required for "built-in" formulae only
%
