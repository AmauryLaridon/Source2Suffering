...
% based on the Seckel and Beaudry (1973) formula presented in 
% Reed (1977), J. Phys. Ocean., 7, 482-485. Assumes the year is not a leap year.
%
...
%
% Notes: The output appears to be very similar to what you would get by
