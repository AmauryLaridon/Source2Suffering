...
%
%              AIR_SEA TOOLBOX (Version 1.1; August 31, 1998)
%
...
%              fluxes into ocean. Uses VISCAIR and QSAT to compute
%              air viscosity and saturation specific humidity, CDNTC 
%              the neutral drag coefficient, and PSIUTC and PSITTC 
%              to adjust the different transfer coefficients to the 
%              measurement heights for a given stability. Also returns other 
%              related variables (e.g., the Monin Obukov height L,
%              Stanton number, etc.).
%
%        SLHFTC: includes ocean surface current and HFBULKTC to compute
...
%    Neutral conditions:  
%
%        CDNLP: Computes neutral drag coefficient and 10m wind following   
%                Large and Pond (1981).
%        CDNTC: Computes neutral drag coefficient and 10m wind following   
%                Smith (1988).
%        CDNVE: Computes neutral drag coefficient and 10m wind following   
%                Vera (1983)
%
%        STRESSLP: computes the neutral wind stress using Large and Pond.
%        STRESSTC: computes the neutral wind stress following Smith
%                  Uses VISCAIR to compute air viscosity.
...
%
% 8) The initial assembly of this toolbox has been a collaborative effort
...
%    Rich Pawlowicz (UBC) did a lot of work turning v1.0 into v1.1.
%    
