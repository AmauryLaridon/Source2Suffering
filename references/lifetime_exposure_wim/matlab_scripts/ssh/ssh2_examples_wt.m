...
command_output = ssh2_simple_command('10.33.211.5','wimt','Wthiery1987','ls -la');
...
command_output = ssh2_simple_command('10.33.211.5','wimt','Wthiery1987','ls -la',1);
...
% Advanced Connection: 
ssh2_conn = ssh2_config('10.33.211.5','wimt','Wthiery1987');
...
ssh2_conn = ssh2_command(ssh2_conn, 'ls -la',1);
...
% above.
filepath_remote = '/media/Wim_02/cclmsq_output/1978-2010_FLake/out06/year1981';
filepath_local  = [pwd '\ncfiles\tmp'];
ssh2_conn = ssh2_config('10.33.211.5','wimt','Wthiery1987');
ssh2_conn = ssh2_command(ssh2_conn, 'ls /media/Wim_02/cclmsq_output/1978-2010_FLake/out06/');
ssh2_conn = scp_get(ssh2_conn, {'lffd1981010103z.nc','lffd1981010106z.nc','lffd1981010109z.nc'},filepath_local,filepath_remote);
