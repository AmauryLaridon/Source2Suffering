function CBH = mf_cbfreeze(varargin)
...
if (nargin~=2) || (isempty(varargin{1}) || ...
    ...
    % Reads CMAP in the first input:
    if nargin && ~isempty(varargin{1}) && isnumeric(varargin{1}) && ...
            (size(varargin{1},2)==3) && ...
