...
flags.plot_sfig10 = 1; % 0: do not plot supplementary figure 10 of paper   !!! PUT TO 1 WHEN RUNNING VALC !!!
                       % 1: plot supplementary figure 10 of paper
flags.plot_sfig11 = 0; % 0: do not plot supplementary figure 11 of paper
                       % 1: plot supplementary figure 11 of paper
flags.plot_sfig12 = 0; % 0: do not plot supplementary figure 12 of paper
                       % 1: plot supplementary figure 12 of paper
flags.plot_sfig13 = 0; % 0: do not plot supplementary figure 13 of paper
                       % 1: plot supplementary figure 13 of paper
flags.plot_sfig14 = 0; % 0: do not plot supplementary figure 14 of paper
                       % 1: plot supplementary figure 14 of paper
flags.plot_sfig15 = 0; % 0: do not plot supplementary figure 15 of paper
                       % 1: plot supplementary figure 15 of paper
flags.plot_sfig16 = 0; % 0: do not plot supplementary figure 16 of paper
                       % 1: plot supplementary figure 16 of paper
flags.plot_sfig17 = 0; % 0: do not plot supplementary figure 17 of paper
                       % 1: plot supplementary figure 17 of paper
flags.plot_sfig18 = 0; % 0: do not plot supplementary figure 18 of paper
                       % 1: plot supplementary figure 18 of paper

                     
% flags for other plots               
flags.plot_4Nico_c  = 1;       % 0: do not plot heatwave exposure conceptual idea under OS and noOS scenarios
                               % 1: plot heatwave exposure conceptual idea under OS and noOS scenarios                               
...
flags.plot_4Romania       = 0; % 0: do not plot bar chart for first expert report in Romania case
                               % 1: plot bar chart for first expert report in Romania case
flags.plot_4UKrep1        = 0; % 0: do not plot bar chart for first expert report in UK case
                               % 1: plot bar chart for first expert report in UK case
flags.plot_4UKrep2        = 0; % 0: do not plot bar chart for second expert report in UK case
                               % 1: plot bar chart for second expert report in UK case
flags.plot_4Norway_ECtHR  = 0; % 0: do not plot bar chart for expert opinion in ECtHR case
                               % 1: plot bar chart for expert opinion in ECtHR case
flags.plot_4Norway_appeal  = 0;% 0: do not plot bar chart for expert opinion in appeal case
                               % 1: plot bar chart for expert opinion in appeal case
...
flags.plot_pdf            = 0; % 0: pdf plot
                               % 1: 
flags.plot_LE0vs5         = 0; % 0: compare life expectancy
                               % 1: 
flags.plot_years_stab     = 0; % 0: compare SR15 and RCP years
                               % 1: 
...
% caxes.EMF                = [1/6     6  ]; %  used for geometric mean - initial submission
caxes.EMF                = [1/5     5  ]; %  used for geometric mean - revised submission
% caxes.EMF_heatwaves      = [1/40    40 ]; %  used for heatwaves - initial submission
caxes.EMF_heatwaves      = [1/10    10 ]; %  used for heatwaves - revised submission

caxes.EMF_BE             = [1       4  ];
caxes.PCT_BE_plot        = [0.001 100000]; % 8 o.o.m., i.e. 2 o.o.m. per risk category, looks good
caxes.EMF_BE_coldwaves   = [1/10    1  ];
...
colormaps.EMF_BE_coldwaves   =        mf_colormap_cpt('cbcGnBu', 40);
...
colormaps.pie   =        mf_colormap_cpt('Set2_07', 7); % ll
...
% define colors
color_15  = colors(27,:); % greens
color_20  = colors(26,:);
color_NDC = colors(25,:);
% color_15  = colors(51,:); % reds
% color_20  = colors(50,:);
% color_NDC = colors(49,:);
...
ind_worldreg = [8 4 2 7 10 1 9 12]; % world regions West to East
...
% % % % for heatwave sensitivity plot
% % % for ind_heatwave=1:length(model_names.heatwavedarea)
% % % ind_gmt                                  = ind_gmt_heatwave(:, ind_heatwave);
% % % exposure_perregion_15( ind_extreme,:,:)  = exposure_perregion_heatwave_permodel_15( ind_heatwave,:,:);
% % % exposure_perregion_20( ind_extreme,:,:)  = exposure_perregion_heatwave_permodel_20( ind_heatwave,:,:);
% % % exposure_perregion_NDC( ind_extreme,:,:) = exposure_perregion_heatwave_permodel_NDC(ind_heatwave,:,:);
% % % EMF_perregion_15( ind_extreme,:,:)       = EMF_perregion_heatwave_permodel_15(      ind_heatwave,:,:);
% % % EMF_perregion_20( ind_extreme,:,:)       = EMF_perregion_heatwave_permodel_20(      ind_heatwave,:,:);
% % % EMF_perregion_NDC(ind_extreme,:,:)       = EMF_perregion_heatwave_permodel_NDC(     ind_heatwave,:,:);
% % % EMF_perregion_q25_15( ind_extreme,:,:)   = EMF_perregion_q25_heatwave_permodel_15(  ind_heatwave,:,:);
% % % EMF_perregion_q25_20( ind_extreme,:,:)   = EMF_perregion_q25_heatwave_permodel_20(  ind_heatwave,:,:);
% % % EMF_perregion_q25_NDC(ind_extreme,:,:)   = EMF_perregion_q25_heatwave_permodel_NDC( ind_heatwave,:,:);
% % % EMF_perregion_q75_15( ind_extreme,:,:)   = EMF_perregion_q75_heatwave_permodel_15(  ind_heatwave,:,:);
% % % EMF_perregion_q75_20( ind_extreme,:,:)   = EMF_perregion_q75_heatwave_permodel_20(  ind_heatwave,:,:);
% % % EMF_perregion_q75_NDC(ind_extreme,:,:)   = EMF_perregion_q75_heatwave_permodel_NDC( ind_heatwave,:,:);
...
[landfrac_peryear_15 , landfrac_peryear_15_mms , ~, ~, ~] = mf_exposure_mmm(extremes, {isimip.extreme}, ind_gmt, ages, age_ref, landfrac_peryear_perregion_15 , [], RCP2GMT_maxdiff_15 , RCP2GMT_maxdiff_threshold);
[landfrac_peryear_20 , landfrac_peryear_20_mms , ~, ~, ~] = mf_exposure_mmm(extremes, {isimip.extreme}, ind_gmt, ages, age_ref, landfrac_peryear_perregion_20 , [], RCP2GMT_maxdiff_20 , RCP2GMT_maxdiff_threshold);
[landfrac_peryear_NDC, landfrac_peryear_NDC_mms, ~, ~, ~] = mf_exposure_mmm(extremes, {isimip.extreme}, ind_gmt, ages, age_ref, landfrac_peryear_perregion_NDC, [], RCP2GMT_maxdiff_NDC, RCP2GMT_maxdiff_threshold);
...
landfrac_15_plot  = smooth(squeeze(landfrac_peryear_15( ind_extreme, ind_region, :)), 10) .* 100;
landfrac_20_plot  = smooth(squeeze(landfrac_peryear_20( ind_extreme, ind_region, :)), 10) .* 100;
landfrac_NDC_plot = smooth(squeeze(landfrac_peryear_NDC(ind_extreme, ind_region, :)), 10) .* 100;


% land fraction uncertainty
landfrac_15_mms_plot  = smooth(squeeze(landfrac_peryear_15_mms( ind_extreme, ind_region, :)), 10) .* 100;
landfrac_20_mms_plot  = smooth(squeeze(landfrac_peryear_20_mms( ind_extreme, ind_region, :)), 10) .* 100;
landfrac_NDC_mms_plot = smooth(squeeze(landfrac_peryear_NDC_mms(ind_extreme, ind_region, :)), 10) .* 100;
...
% plot uncertainty band around the lines
xvals = years_SR15(1:end-4);
yvals = landfrac_15_plot(1:end-4);
dyvals = landfrac_15_mms_plot(1:end-4)./2;
fill([xvals; flipud(xvals)], [yvals - dyvals; flipud(yvals + dyvals)], color_15, 'FaceAlpha', 0.1, 'EdgeColor', 'none'); hold on; % plot filled area
yvals = landfrac_20_plot(1:end-4);
dyvals = landfrac_20_mms_plot(1:end-4)./2;
fill([xvals; flipud(xvals)], [yvals - dyvals; flipud(yvals + dyvals)], color_20, 'FaceAlpha', 0.1, 'EdgeColor', 'none'); hold on; % plot filled area
yvals = landfrac_NDC_plot(1:end-4);
dyvals = landfrac_NDC_mms_plot(1:end-4)./2;
fill([xvals; flipud(xvals)], [yvals - dyvals; flipud(yvals + dyvals)], color_NDC, 'FaceAlpha', 0.1, 'EdgeColor', 'none'); hold on; % plot filled area
...
ylims = [0 55];%ylim % get y-axis limits
set(gca, 'ylim', ylims);
plot([2020 2020], [ylims(1) ylims(2)-ylims(2)*0.01], 'color', boxcolor, 'linewidth', 2); hold on;


% add title
text(years_SR15(1), ylims(2) + ylims(2)*0.01, 'a Period perspective','ver','bottom','hor','left','Fontsize', 12, 'Fontweight', 'bold', 'color', boxcolor)


% draw arrow and text for 60yr old
ind_age = ages==age_ref_plot;
arrow_start = regions.birth_years{ind_region}(ind_age);
arrow_end   = regions.birth_years{ind_region}(ind_age)+regions.life_expectancy_5{ind_region}(ind_age);
mf_dataArrow([arrow_start arrow_end], [42 42], gca, axcolor, 3, 'vback1');
plot([arrow_end arrow_end], [41 43], 'color', axcolor, 'linewidth', 1.5); hold on; % add small vertical line atthe end of the grey arrow
text(regions.birth_years{ind_region}(ind_age)+regions.life_expectancy_5{ind_region}(ind_age)./2, 42.5, ['Life expectancy of the 1960 birth cohort'], 'FontSize', 11, 'Fontweight', 'Bold', 'color', axcolor, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'bottom')
...
arrow_start = regions.birth_years{ind_region}(ind_age);
arrow_end   = regions.birth_years{ind_region}(ind_age)+regions.life_expectancy_5{ind_region}(ind_age);
mf_dataArrow([arrow_start arrow_end], [53 53], gca, axcolor, 3, 'vback1');
plot([arrow_end arrow_end], [52 54], 'color', axcolor, 'linewidth', 1.5); hold on; % add small vertical line atthe end of the grey arrow
text(regions.birth_years{ind_region}(ind_age)+regions.life_expectancy_5{ind_region}(ind_age)./2, 53.5, 'Life expectancy of the 2020 birth cohort', 'FontSize', 11, 'Fontweight', 'Bold', 'color', axcolor, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'bottom')
...
ylabel('Lifetime heatwave exposure [-]', 'Fontsize', 12, 'Fontweight', 'Bold'); 
...
ymax = 9;%max([EMF_plot_q75_NDC(end) EMF_plot_q75_20(end) EMF_plot_q75_15(end)]);
...
h(4) = plot(0.1, 0.9 , 'w'); hold on;                                                                    % dummy data to have y-axis starting at 0
...
% add title
ylims = ylim; % get y-axis limits
text(ages(1), ylims(2) + ylims(2)*0.01, 'c  Cohort perspective','ver','bottom','hor','left','Fontsize', 12, 'Fontweight', 'bold', 'color', boxcolor)
...
axis(axlims);
set(gca, 'position', ax4_pos, 'Fontsize', 15, 'Fontweight', 'Bold', 'Xcolor', axcolor, 'Ycolor', axcolor, 'clipping', 'off');
axis off
...
% % % % define ages for which to plot pie chart
% % % ax6 = axes('Position',[0.50 0.45 0.5 0.45]);
% % % mf_plot_pie(EMF_perregion_NDC, EMF_perregion_20, EMF_perregion_15, ages, 60:-20:0, 4, regions, extremes, 5, ind_income, '', color_NDC, color_20, color_15, 2, 8, 1)


% save figure
% export_fig('figures/fig1_conceptual.png', '-transparent');
% export_fig('figures/fig1_conceptual_reds.png', '-transparent');
exportgraphics(gcf, 'figures/fig1_conceptual.pdf', 'ContentType', 'vector')
% % % export_fig(['figures/heatwave_sensitivity/fig1_conceptual_' model_names.heatwavedarea{ind_heatwave} '.png'], '-transparent');
% % % end
...
% define panel letters for region plots
panelletters_extremes = {'a', 'b', 'd', 'c', 'a', 'b', 'a'};
...
%     for ind_extreme = nextremes+1
        ...
        mf_plot_burning_embers(ages, GMT_BE, EMF_region_plot_BE, PCT_region_plot_BE, colormaps.BE_continuous, caxes.EMF_BE_pe(ind_extreme,:), ind_region, ind_extreme, age_ref, agegroups, regions, year_start, nextremes, panelletters_extremes, extremes, extremes_legend, axcolor, 2, [])
...
%         exportgraphics(gcf, ['figures/burning_embers/EMF_PCTcont_region_GMT_BE_' regions.name{ind_region} '_'  extremes_legend{ind_extreme} '.pdf'], 'ContentType', 'vector');
%         export_fig(['figures/burning_embers/EMF_PCTcont_region_GMT_BE_' regions.name{ind_region} '_'  extremes_legend{ind_extreme} '_hwmid99.png'], '-transparent');
%         export_fig(['figures/burning_embers/EMF_PCTcont_region_GMT_BE_' regions.name{ind_region} '_'  extremes_legend{ind_extreme} '_hwmid-humidex.png'], '-transparent');
%         export_fig(['figures/burning_embers/EMF_PCTcont_region_GMT_BE_' regions.name{ind_region} '_'  extremes_legend{ind_extreme} '_hwmid99-tasmax35.png'], '-transparent');
%         export_fig(['figures/burning_embers/EMF_PCTcont_region_GMT_BE_' regions.name{ind_region} '_'  extremes_legend{ind_extreme} '_hwmid99-humidex40.png'], '-transparent');
%         export_fig(['figures/burning_embers/EMF_PCTcont_region_GMT_BE_' regions.name{ind_region} '_'  extremes_legend{ind_extreme} '_hwmid97p5-tasmax35.png'], '-transparent');
...
h(1) = plot(years_SR15, GMT_NDC, 'color', color_NDC, 'linewidth', 3); hold on;
h(2) = plot(years_SR15, GMT_20, 'color', color_20, 'linewidth', 3); hold on;
h(3) = plot(years_SR15, GMT_15, 'color', color_15, 'linewidth', 3); hold on;
...
set(gca, 'xlim', [1950 2110], 'Fontsize', 15, 'Fontweight', 'Bold', 'Xcolor', axcolor, 'Ycolor', axcolor);
...
export_fig('figures/GMT_BE_reds.png', '-transparent');
% exportgraphics(gcf, 'figures/GMT_BE.pdf', 'ContentType', 'vector');
...
% --------------------------------------------------------------------
% paper supplementary figure 2 - BE per extreme event category
% --------------------------------------------------------------------
...
for ind_region = 12
    ...
    for ind_extreme = nextremes+1
        ...
        % save figure
        export_fig(['figures/burning_embers/EMF_PCTcont_region_GMT_BE_' regions.name{ind_region} '_'  extremes_legend{ind_extreme} '_geomemf_testtt.png'], '-transparent');
        ...
        % save figure
        export_fig(['figures/burning_embers/EMF_PCTcont_region_GMT_BE_' regions.name{ind_region} '_'  extremes_legend{ind_extreme} '_geomexp_testtt.png'], '-transparent');
        ...
        % save figure
        export_fig(['figures/burning_embers/EMF_PCTcont_region_GMT_BE_' regions.name{ind_region} '_'  extremes_legend{ind_extreme} '_harmmean_testtt.png'], '-transparent');
...
% --------------------------------------------------------------------
% paper supplementary figure 4 - world regions & incomee groups maps
% --------------------------------------------------------------------
...
% --------------------------------------------------------------------
% paper supplementary figure 5 - BE per world region
% --------------------------------------------------------------------
...
% --------------------------------------------------------------------
% paper supplementary figure 6 - BE per income group
% --------------------------------------------------------------------
...
% --------------------------------------------------------------------
% paper supplementary figure 7 - EMF maps per extreme
% --------------------------------------------------------------------
...
EMF_map_young2pic_15_allhazards   = NaN(nlat, nlon);
EMF_map_young2pic_20_allhazards   = NaN(nlat, nlon);
EMF_map_young2pic_NDC_allhazards  = NaN(nlat, nlon);
...
for ind_country = 1:ncountries
    ...
    % reconstruct global map - young2pic only used for ISIpedia article
    EMF_map_young2pic_15_allhazards( countries.mask{ind_country}) = EMF_15_young2pic( nextremes + 1, ind_country, ages==age_young);
    EMF_map_young2pic_20_allhazards( countries.mask{ind_country}) = EMF_20_young2pic( nextremes + 1, ind_country, ages==age_young);
    EMF_map_young2pic_NDC_allhazards(countries.mask{ind_country}) = EMF_NDC_young2pic(nextremes + 1, ind_country, ages==age_young);
    
    % reconstruct global map
    exposure_map_15_allhazards( countries.mask{ind_country}) = exposure_15( nextremes + 1, ind_country, ages==age_young);
    exposure_map_20_allhazards( countries.mask{ind_country}) = exposure_20( nextremes + 1, ind_country, ages==age_young);
    exposure_map_NDC_allhazards(countries.mask{ind_country}) = exposure_NDC(nextremes + 1, ind_country, ages==age_young);
...
% rescale for plotting - young2pic only used for ISIpedia article
EMF_map_young2pic_15_allhazards_plot  = mf_PR_plotscale(EMF_map_young2pic_15_allhazards);
EMF_map_young2pic_20_allhazards_plot  = mf_PR_plotscale(EMF_map_young2pic_20_allhazards);
EMF_map_young2pic_NDC_allhazards_plot = mf_PR_plotscale(EMF_map_young2pic_NDC_allhazards);


% rescale for plotting - young2pic only used for ISIpedia article
exposure_map_15_allhazards_plot  = mf_PR_plotscale(exposure_map_15_allhazards);
exposure_map_20_allhazards_plot  = mf_PR_plotscale(exposure_map_20_allhazards);
exposure_map_NDC_allhazards_plot = mf_PR_plotscale(exposure_map_NDC_allhazards);
...
% % % % export_fig figures/EMF_map_young2ref_15_allhazards_lowres_geomean_on_EMF_hwmid99.png  -transparent;
% % % % export_fig figures/EMF_map_young2ref_15_allhazards_highres_geomean_on_EMF_4CarbonBrief.png -m10 -transparent; close all;
% % % 
% % % 
% % % % young2ref EMF map - 2.0°C - all hazards
% % % cbh = mf_plot_dom2(lon_mod, lat_mod, EMF_map_young2ref_20_allhazards_plot, [], island, caxes.EMF_plot, colormaps.EMF, 0, 2, 'd', ['2.0°C warming - ' num2str(age_young) 'yr compared to ' num2str(age_ref) 'yr'], 'Exposure multiplication factor'); hold on;
% % % set(cbh,'XTickLabel',{'\div5','\div4','\div3','\div2','\times1','\times2','\times3','\times4','\times5'}, 'Xtick', mf_PR_plotscale([1/5 1/4 1/3 1/2 1 2 3 4 5]))
% % % imagesc([pictogram_dims(nextremes+1,1) pictogram_dims(nextremes+1,2)], [pictogram_dims(nextremes+1,3) pictogram_dims(nextremes+1,4)], pictogram_all_2x3); hold off   % add pictogram
% % % export_fig figures/EMF_map_young2ref_20_allhazards_lowres_geomean_on_EMF.png  -transparent;
% % % % export_fig figures/EMF_map_young2ref_20_allhazards_lowres_geomean_on_EMF_hwmid99.png  -transparent;
% % % % export_fig figures/EMF_map_young2ref_20_allhazards_highres_geomean_on_EMF_4CarbonBrief.png -m10 -transparent; close all;
% % % 
% % % 
...
% % % % export_fig figures/EMF_map_young2ref_NDC_allhazards_lowres_geomean_on_EMF_hwmid99.png  -transparent;
% % % % export_fig figures/EMF_map_young2ref_NDC_allhazards_highres_geomean_on_EMF_4CarbonBrief.png  -m10 -transparent; close all;


% define panel letters
panelletters_15  = {'b', 'd', 'f', 'h', 'b', 'j'};
panelletters_20  = {'x', 'x', 'x', 'x', 'x', 'x'};
...
for i=1:nextremes    
    ...
    EMF_map_young2ref_20(i).perextreme       = NaN(nlat, nlon);
    EMF_map_young2ref_NDC(i).perextreme      = NaN(nlat, nlon);
    EMF_map_young2pic_15(i).perextreme       = NaN(nlat, nlon);
    EMF_map_young2pic_20(i).perextreme       = NaN(nlat, nlon);
    EMF_map_young2pic_NDC(i).perextreme      = NaN(nlat, nlon);
    exposure_map_15(i).perextreme  = NaN(nlat, nlon);
    exposure_map_20(i).perextreme  = NaN(nlat, nlon);
    exposure_map_NDC(i).perextreme = NaN(nlat, nlon);
    ...
    for ind_country = 1:ncountries
        ...
        EMF_map_young2ref_20(i).perextreme( countries.mask{ind_country}) = EMF_20( i, ind_country, ages==age_young);
        EMF_map_young2ref_NDC(i).perextreme(countries.mask{ind_country}) = EMF_NDC(i, ind_country, ages==age_young);
        
        % exposure
        exposure_map_15(i).perextreme( countries.mask{ind_country}) = exposure_15( i, ind_country, ages==age_young);
        exposure_map_20(i).perextreme( countries.mask{ind_country}) = exposure_20( i, ind_country, ages==age_young);
        exposure_map_NDC(i).perextreme(countries.mask{ind_country}) = exposure_NDC(i, ind_country, ages==age_young);
        
        % EMF - young2pic only used for ISIpedia article
        EMF_map_young2pic_15(i).perextreme( countries.mask{ind_country}) = EMF_15_young2pic( i, ind_country, ages==age_young);
        EMF_map_young2pic_20(i).perextreme( countries.mask{ind_country}) = EMF_20_young2pic( i, ind_country, ages==age_young);
        EMF_map_young2pic_NDC(i).perextreme(countries.mask{ind_country}) = EMF_NDC_young2pic(i, ind_country, ages==age_young);
    ...
    EMF_map_young2ref_20(i).perextreme_plot  = mf_PR_plotscale(EMF_map_young2ref_20(i).perextreme ); 
    EMF_map_young2ref_NDC(i).perextreme_plot = mf_PR_plotscale(EMF_map_young2ref_NDC(i).perextreme); 
  
    
    % rescale for plotting - young2pic only used for ISIpedia article
    EMF_map_young2pic_15(i).perextreme_plot  = mf_PR_plotscale(EMF_map_young2pic_15(i).perextreme ); 
    EMF_map_young2pic_20(i).perextreme_plot  = mf_PR_plotscale(EMF_map_young2pic_20(i).perextreme ); 
    EMF_map_young2pic_NDC(i).perextreme_plot = mf_PR_plotscale(EMF_map_young2pic_NDC(i).perextreme); 
...
% % %         XTickLabel_perextreme = {'\div10','\div8','\div6','\div4','\div2','\times2','\times4','\times6','\times8','\times10'};
% % %         XTicks_perextreme     = mf_PR_plotscale([1/10 1/8 1/6 1/4 1/2 2 4 6 8 10]);
% % %     else
% % %         caxes.EMF_perextreme  = caxes.EMF_plot;
% % %         XTickLabel_perextreme = {'\div5','\div4','\div3','\div2','\times1','\times2','\times3','\times4','\times5'};
% % %         XTicks_perextreme     = mf_PR_plotscale([1/5 1/4 1/3 1/2 1 2 3 4 5]);
% % %     end
% % %     
% % %     
...
% % %     %export_fig(['figures/EMF_map_young2ref_15_' extremes{i} '_highres_4CarbonBrief.png' ], '-transparent', '-m10'); close all;
% % %     
% % %     
% % %     % young2ref EMF map - 2.0°C - per extreme
% % %     cbh = mf_plot_dom2(lon_mod, lat_mod, EMF_map_young2ref_20(i).perextreme_plot, [], island, caxes.EMF_perextreme, colormaps.EMF, 0, 2, panelletters_20{i}, ['2.0°C warming - ' extremes_legend{i} ' - ' num2str(age_young) 'yr compared to ' num2str(age_ref) 'yr'], 'Exposure multiplication factor'); hold on;
% % %     set(cbh,'XTickLabel',XTickLabel_perextreme, 'Xtick', XTicks_perextreme)
% % %     imagesc([pictogram_dims(i,1) pictogram_dims(i,2)], [pictogram_dims(i,3) pictogram_dims(i,4)], pictogram); hold off   % add pictogram
% % %     export_fig(['figures/EMF_map_young2ref_20_' extremes{i} '_lowres.png' ], '-transparent');
% % % %     export_fig(['figures/EMF_map_young2ref_20_' extremes{i} '_highres_4CarbonBrief.png' ], '-transparent', '-m10'); close all;
% % % 
% % %     
...
% % %     %export_fig(['figures/EMF_map_young2ref_NDC_' extremes{i} '_highres_4CarbonBrief.png' ], '-transparent', '-m10'); close all;
% % % 
% % %     
% % % %     % maps for heatwave definition sensitivity
% % % %     if strcmp(extremes{i}, 'heatwavedarea')
% % % % 
% % % %        for ind_heatwave=1:length(model_names.heatwavedarea)
% % % %     
% % % %             % initialise arrays
% % % %             EMF_map_young2ref_15(ind_heatwave).permodel       = NaN(nlat, nlon);
% % % %             EMF_map_young2ref_NDC(ind_heatwave).permodel      = NaN(nlat, nlon);
% % % % 
% % % % 
% % % %             % loop over countries
% % % %             for ind_country = 1:ncountries
% % % % 
% % % %                 % EMF
% % % %                 EMF_map_young2ref_NDC(ind_heatwave).permodel(countries.mask{ind_country}) = EMF_heatwave_permodel_NDC(ind_heatwave, ind_country, ages==age_young);
% % % %                 EMF_map_young2ref_15(ind_heatwave).permodel( countries.mask{ind_country}) = EMF_heatwave_permodel_15( ind_heatwave, ind_country, ages==age_young);
% % % % 
% % % %             end
% % % % 
% % % % 
% % % %             % rescale for plotting
% % % %             EMF_map_young2ref_15(ind_heatwave).permodel_plot  = mf_PR_plotscale(EMF_map_young2ref_15(ind_heatwave).permodel ); 
% % % %             EMF_map_young2ref_NDC(ind_heatwave).permodel_plot = mf_PR_plotscale(EMF_map_young2ref_NDC(ind_heatwave).permodel); 
% % % %            
% % % %             
% % % %             % remove the alternative heatwave definitions from the selection prior to computing the mutli-model mean
% % % %             if strcmp(model_names.heatwavedarea{ind_heatwave}, 'CWMId99')
% % % %                 panelletter_heatwaves = 'b';
% % % %             else
% % % %                 panelletter_heatwaves = alphabet(ind_heatwave);
% % % %             end
% % % % 
% % % %             
% % % %            
% % % %             % young2ref EMF map - 1.5°C - heatwaves - per heatwave definition
% % % %             cbh = mf_plot_dom2(lon_mod, lat_mod, EMF_map_young2ref_15(ind_heatwave).permodel_plot, [], island, caxes.EMF_perextreme, colormaps.EMF, 0, 2, panelletter_heatwaves, ['1.5°C warming - ' model_names.heatwavedarea{ind_heatwave} ' - ' num2str(age_young) 'yr compared to ' num2str(age_ref) 'yr'], 'Exposure multiplication factor'); hold on;
% % % %             set(cbh,'XTickLabel',XTickLabel_perextreme, 'Xtick', XTicks_perextreme)
% % % %             imagesc([pictogram_dims(i,1) pictogram_dims(i,2)], [pictogram_dims(i,3) pictogram_dims(i,4)], pictogram); hold off   % add pictogram
% % % %             export_fig(['figures/heatwave_sensitivity/EMF_map_young2ref_15_' extremes{i} '_' model_names.heatwavedarea{ind_heatwave} '_lowres.png' ], '-transparent');
% % % %             % export_fig(['figures/heatwave_sensitivity/EMF_map_young2ref_15_' extremes{i} '_' model_names.heatwavedarea{ind_heatwave} '_highres.png' ], '-transparent', '-m10'); close all;
% % % % 
% % % % 
% % % %             % young2ref EMF map - NDC - heatwaves - per heatwave definition
% % % %             cbh = mf_plot_dom2(lon_mod, lat_mod, EMF_map_young2ref_NDC(ind_heatwave).permodel_plot, [], island, caxes.EMF_perextreme, colormaps.EMF, 0, 2, panelletter_heatwaves, ['Current pledges - ' model_names.heatwavedarea{ind_heatwave} ' - ' num2str(age_young) 'yr compared to ' num2str(age_ref) 'yr'], 'Exposure multiplication factor'); hold on;
% % % %             set(cbh,'XTickLabel',XTickLabel_perextreme, 'Xtick', XTicks_perextreme)
% % % %             imagesc([pictogram_dims(i,1) pictogram_dims(i,2)], [pictogram_dims(i,3) pictogram_dims(i,4)], pictogram); hold off   % add pictogram
% % % %             export_fig(['figures/heatwave_sensitivity/EMF_map_young2ref_NDC_' extremes{i} '_' model_names.heatwavedarea{ind_heatwave} '_lowres.png' ], '-transparent');
% % % %             % export_fig(['figures/heatwave_sensitivity/EMF_map_young2ref_NDC_' extremes{i} '_' model_names.heatwavedarea{ind_heatwave} '_highres.png' ], '-transparent', '-m10'); close all;
% % % %           
% % % %             
% % % %        end
% % % %         
...
% --------------------------------------------------------------------
% paper supplementary figure 8 - EMF maps per extreme
% --------------------------------------------------------------------
...
% --------------------------------------------------------------------
% paper supplementary figure 9 - line plots per region
% --------------------------------------------------------------------
...
% plot world regions
mf_plot_regions_NDC_EMF(exposure_perregion_NDC, EMF_perregion_NDC_young2pic, EMF_perregion_q25_NDC_young2pic, EMF_perregion_q75_NDC_young2pic, exposure_perregion_mms_NDC, ages, agegroups, regions, year_start, nextremes, ind_worldreg, 'a', [], [0.75 13.5], 'worldregions') % used to be 15.5
...
% export_fig('figures/per_region/exposure_region_GMT_perscenario_worldregions_geomean_maxdiff02_EMF_young2pic_hwmid99.png', '-transparent');
% export_fig('figures/per_region/exposure_region_GMT_perscenario_worldregions_CBcolors.png', '-transparent');


% plot income regions
mf_plot_regions_NDC_EMF(exposure_perregion_NDC, EMF_perregion_NDC_young2pic, EMF_perregion_q25_NDC_young2pic, EMF_perregion_q75_NDC_young2pic, exposure_perregion_mms_NDC, ages, agegroups, regions, year_start, nextremes, ind_income  , 'b', colormaps.regions_income, [0.75 7.0], 'income')
...
% export_fig('figures/per_region/exposure_region_GMT_perscenario_incomegroups_geomean_maxdiff02_EMF_young2pic_hwmid99.png', '-transparent');
% exportgraphics(gcf, 'figures/per_region/exposure_region_GMT_perscenario_incomegroups_geomean_maxdiff02_EMF_young2pic.pdf', 'ContentType','vector')
...
% --------------------------------------------------------------------
% paper supplementary figure 10 - regional pie charts - young2pic
% --------------------------------------------------------------------
...
% define EMF label step and maximum - picontrol reference
EMF_label_max_young2pic = [4; ...   % burntarea
                           8; ...   % cropfailedarea
                           8; ...   % driedarea
                           8; ...   % floodedarea
                          32; ...   % heatwavedarea
                           8; ...   % tropicalcyclone
                           8  ];    % all
EMF_label_step_young2pic = [1; ...   % burntarea
                            2; ...   % cropfailedarea
                            2; ...   % driedarea
                            2; ...   % floodedarea
                            8; ...   % heatwavedarea
...
% create figure
subtightplot = @(m,n,p) mf_subtightplot (m, n, p, [0.01 0.001], [0.05 0.05], [0.01 0.01]);
figure('OuterPosition',[100 10 900 1300]);
set(gcf, 'color', 'w');
set(gca,'color','w');
counter = 1;
...
for ind_age=1:length(ages_pie)
    ...
    for ind_region=1:nregions
        ...
        regions.cohort_size{ind_region,ind_age}  = sum(regions.cohort_weights{ind_region}(:,:,ages==ages_pie(ind_age)));

        % get relative cohort sizes of newborns for each region in 2020
        regions.cohort_size_rel{ind_region,ind_age}  = sum(regions.cohort_weights{ind_region}(:,:,ages==ages_pie(ind_age))) ./ sum(regions.cohort_weights{12}(:,:,ages==ages_pie(ind_age)));

    end


    % plot cohort distribution income group - plain pie chart
    subtightplot(nextremes+2,4,counter);        
    pieHandle = pie(cell2mat(regions.cohort_size_rel(ind_worldreg(1:end-1),ind_age)), regions.name_short(ind_worldreg(1:end-1)));
    title([num2str(ages_pie(ind_age)) ' years in 2020'],'Fontsize', 15, 'Fontweight', 'bold', 'color', axcolor)
    colormap(colormaps.pie)
    for iHandle = 2:2:2*numel(regions.name(ind_worldreg(1:end-1)))
...
for ind_extreme=1:nextremes+1
    ...
    for ind_age=1:length(ages_pie)
        ...
        % call function to plot pie chart per world region
        subtightplot(nextremes+2,4,counter);        
        mf_plot_pie(EMF_perregion_NDC_young2pic, EMF_perregion_20_young2pic, EMF_perregion_15_young2pic, ages, ages_pie, ind_age, regions, extremes, ind_extreme, ind_worldreg(1:end-1)    , '', color_NDC, color_20, color_15, EMF_label_step_young2pic(ind_extreme), EMF_label_max_young2pic(ind_extreme), 0)
    ...
    if ind_extreme == nextremes+1
        ...
        ax2 = axes('Position',[0.001 0.07 0.06 0.06]); 
    else
        pictogram = imadjust(imcomplement(imread(['pictogram_' extremes{ind_extreme} '.png'])),[0.3 0.3 0.3; 1 1 1],[]);
        ax2 = axes('Position',[0.001 0.88-0.116*ind_extreme 0.055 0.06]); 
    end
    imagesc(pictogram); hold on   % add pictogram
    axis('off', 'image');
...
% save figue
% export_fig('C:/Users/wthiery/Dropbox/Apps/Overleaf/Thiery_etal_2020_ISIMIP2b_exposure/figures_paper/supp_figure_10.png', '-transparent');
% exportgraphics(gcf, 'C:/Users/wthiery/Dropbox/Apps/Overleaf/Thiery_etal_2020_ISIMIP2b_exposure/figures_paper/supp_figure_10.pdf', 'ContentType', 'vector');
...
for ind_age=1:length(ages_pie)
    ...
    % plot cohort distribution income group - plain pie chart
    subtightplot(nextremes+2,4,counter);        
    pieHandle = pie(cell2mat(regions.cohort_size_rel(ind_income,ind_age)), regions.name_short(ind_income));
    title([num2str(ages_pie(ind_age)) ' years in 2020'],'Fontsize', 15, 'Fontweight', 'bold', 'color', axcolor)
    colormap(colormaps.regions_income)
    for iHandle = 2:2:2*numel(regions.name(ind_income))
        pieHandle(iHandle).Color    = axcolor;
    end
...
for ind_extreme=1:nextremes+1
    ...
    for ind_age=1:length(ages_pie)
        ...
        % call function to plot pie chart per income group
        subtightplot(nextremes+2,4,counter);        
        mf_plot_pie(EMF_perregion_NDC_young2pic, EMF_perregion_20_young2pic, EMF_perregion_15_young2pic, ages, ages_pie, ind_age, regions, extremes, ind_extreme, ind_income           , '', color_NDC, color_20, color_15, EMF_label_step_young2pic(ind_extreme), EMF_label_max_young2pic(ind_extreme), 0)
...
% save figue
% export_fig('C:/Users/wthiery/Dropbox/Apps/Overleaf/Thiery_etal_2020_ISIMIP2b_exposure/figures_paper/supp_figure_11.png', '-transparent');
% exportgraphics(gcf, 'C:/Users/wthiery/Dropbox/Apps/Overleaf/Thiery_etal_2020_ISIMIP2b_exposure/figures_paper/supp_figure_11.pdf', 'ContentType', 'vector');
close all
...
% --------------------------------------------------------------------
% paper supplementary figure 11 - regional pie charts - young2pic
% --------------------------------------------------------------------


if flags.plot_sfig11 == 1

disp('run plot_sfig10');
...
% --------------------------------------------------------------------
% paper supplementary figure 12 - regional pie charts young2ref
% --------------------------------------------------------------------


if flags.plot_sfig12 == 1


% define EMF label step and maximum - historical reference
EMF_label_max = [4; ...   % burntarea
                 4; ...   % cropfailedarea
                 4; ...   % driedarea
                 4; ...   % floodedarea
                 8; ...   % heatwavedarea
...
for ind_extreme=1:nextremes+1
    ...
    for ind_age=1:length(ages_pie)
        ...
        % call function to plot pie chart per world region
        subtightplot(nextremes+2,4,counter);        
        mf_plot_pie(EMF_perregion_NDC, EMF_perregion_20, EMF_perregion_15, ages, ages_pie, ind_age, regions, extremes, ind_extreme, ind_worldreg(1:end-1)    , '', color_NDC, color_20, color_15, EMF_label_step(ind_extreme), EMF_label_max(ind_extreme), 0)
...
% save figue
% export_fig('C:/Users/wthiery/Dropbox/Apps/Overleaf/Thiery_etal_2020_ISIMIP2b_exposure/figures_paper/supp_figure_12.png', '-transparent');
exportgraphics(gcf, 'C:/Users/wthiery/Dropbox/Apps/Overleaf/Thiery_etal_2020_ISIMIP2b_exposure/figures_paper/supp_figure_12.pdf', 'ContentType', 'vector');
...
for ind_extreme=1:nextremes+1
    ...
    for ind_age=1:length(ages_pie)
        ...
        % call function to plot pie chart per income group
        subtightplot(nextremes+2,4,counter);        
        mf_plot_pie(EMF_perregion_NDC, EMF_perregion_20, EMF_perregion_15, ages, ages_pie, ind_age, regions, extremes, ind_extreme, ind_income           , '', color_NDC, color_20, color_15, EMF_label_step(ind_extreme), EMF_label_max(ind_extreme), 0)
...
% save figue
% export_fig('C:/Users/wthiery/Dropbox/Apps/Overleaf/Thiery_etal_2020_ISIMIP2b_exposure/figures_paper/supp_figure_13.png', '-transparent');
exportgraphics(gcf, 'C:/Users/wthiery/Dropbox/Apps/Overleaf/Thiery_etal_2020_ISIMIP2b_exposure/figures_paper/supp_figure_13.pdf', 'ContentType', 'vector');
...
% --------------------------------------------------------------------
% paper supplementary figure 13 - regional pie charts - young2ref
% --------------------------------------------------------------------


if flags.plot_sfig13 == 1

disp('run plot_sfig12');
...
% --------------------------------------------------------------------
% paper supplementary figure 14 - life expectancy data
% --------------------------------------------------------------------


if flags.plot_sfig14 == 1
...
for ind_region = 12%1:nregions
    ...
    figure
    set(gcf, 'color', 'w');
    plot(birth_years, regions.life_expectancy_5{ind_region}, 'color', axcolor, 'linewidth', 3); hold on;
    ...
    ylabel('Cohort life expectancy at birth', 'Fontsize', 15, 'Fontweight', 'Bold'); 
   
    % save figure
    % export_fig(['figures/per_region/life_expectancy_' regions.name{ind_region} '.png'], '-transparent');
    exportgraphics(gcf, ['figures/per_region/life_expectancy_' regions.name{ind_region} '.pdf'], 'ContentType', 'vector');
...
%     figure;
%     set(gcf, 'color', 'w');
%     plot(birth_years, countries.life_expectancy_5{ind_country}, 'color', axcolor, 'linewidth', 3); hold on;
...
% --------------------------------------------------------------------
% paper supplementary figure 15 and 16 - area plots per region per GMT 
% per cause (constant life expectancy vs. full signal)
% --------------------------------------------------------------------


if flags.plot_sfig15 == 1
...
%                                        flipud(squeeze(exposure_perregion_diff_dle(nextremes + 1, ind_region, :)))        ];
    ...
    % compute arithmetic mean of the per-category exposure to be consistent with the pic exposure
    exposure_perregion_NDC_meanexp             = mean(exposure_perregion_NDC(            1:nextremes,:,:),1, 'omitnan');
    exposure_perregion_pic_mean_meanexp        = mean(exposure_perregion_pic_mean(       1:nextremes,:  ),1, 'omitnan');
    exposure_perregion_pic_mean_perage_meanexp = mean(exposure_perregion_pic_mean_perage(1:nextremes,:,:),1, 'omitnan');
    
    
    % compute difference in exposure between CC+life expectancy change, and CC given constant life expectancy
    exposure_perregion_diff_dle     = exposure_perregion_pic_mean_perage_meanexp - repmat(exposure_perregion_pic_mean_meanexp, 1, 1, nbirthyears);                               % change in exposure due to changing life expectancy
    exposure_perregion_diff_cc      = exposure_perregion_NDC_meanexp     - exposure_perregion_diff_dle - repmat(exposure_perregion_pic_mean_meanexp, 1, 1, nbirthyears); % change in exposure due to climate change (defined as total exposure - picontrol exposure - life expectancy effect)
...
% %     EMF_perregion_plot_NDC_young2pic = flipud(squeeze(exposure_perregion_NDC_meanexp(nextremes + 1, ind_region, :) ./ exposure_perregion_pic_mean(nextremes + 1, ind_region, :)));
%     for i=1:min(ceil(max(EMF_perregion_plot_NDC_young2pic)), 50)
...
%     hold off;
    ...
    for i=1:size(agegroups,1)
          mf_dataTextbox([agegroups{i,2}-year_start agegroups{i,3}-year_start], [0.001 0.04], agegroups{i,1}, 'w', 'w', 'w'); % make boxes invisible; used to be ", axcolor, axcolor, 'w'"
    end
    ...
    % save figure
    export_fig(['figures/per_region/exposure_region_GMT_percause_' regions.name{ind_region} '_arithmean.png'], '-transparent');
...
% --------------------------------------------------------------------
% paper supplementary figure 16 - area plots per region per GMT 
% per cause (constant life expectancy vs. full signal)
% --------------------------------------------------------------------


if flags.plot_sfig16 == 1

disp('run plot_sfig15');
...
% --------------------------------------------------------------------
% paper supplementary figure 17 - time shift method evaluation (RCP2.6)
% --------------------------------------------------------------------


if flags.plot_sfig17 == 1
...
set(gcf, 'color', 'w');
for i=1:nextremes+1
plot(exposure_perregion_R26(i, :, ages == age_young), exposure_perregion_R26eval(i, :,  ages == age_young), '.', 'markersize', 9); hold on
end
axis([0 4.5 0 4.5]);
set(gca, 'Fontsize', 15, 'Fontweight', 'Bold', 'Xcolor', axcolor, 'Ycolor', axcolor);
xlabel('RCP2.6 direct', 'Fontsize', 15, 'Fontweight', 'Bold'); 
ylabel('RCP2.6 reconstructed (time shift)', 'Fontsize', 15, 'Fontweight', 'Bold'); 
ylims = ylim;
text(0, ylims(2) + ylims(2)*0.01, 'Lifetime absolute exposure of 2020 birth cohort','ver','bottom','hor','left','Fontsize', 13, 'Fontweight', 'bold', 'color', axcolor)
legend(extremes_legend, 'location', 'Northwest');
set(legend, 'box', 'off', 'Fontweight', 'Bold', 'Fontsize', 12, 'textcolor', axcolor);


% save figure
% export_fig('figures/exposure_RCP26_evaluation.png', '-transparent');
exportgraphics(gcf, 'figures/exposure_RCP26_evaluation.pdf', 'ContentType', 'vector');
...
% --------------------------------------------------------------------
% paper supplementary figure 18 - BE cold extremes figure
% --------------------------------------------------------------------


if flags.plot_sfig18 == 1


if flags.coldwaves == 1
    ...
    %     for ind_extreme = nextremes+1
            ...
            % call plotting function
            mf_plot_burning_embers(ages, GMT_BE, EMF_region_plot_BE, PCT_region_plot_BE, colormaps.EMF_BE_coldwaves, caxes.EMF_BE_coldwaves, ind_region, ind_extreme, age_ref, agegroups, regions, year_start, nextremes, panelletters_regions, extremes, {'NaN' 'NaN' 'NaN' 'NaN' 'Coldwaves'}, axcolor, 2, [])


            % save figure
            export_fig(['figures/burning_embers/EMF_PCTcont_region_GMT_BE_' regions.name{ind_region} '_Coldwaves.png'], '-transparent');
...
elseif flags.coldwaves == 0
    
    disp('re-run with flags.coldwaves == 1 for producing the coldwave plot');
...
% --------------------------------------------------------------------
% conceptual figure for Nico Bauer
% --------------------------------------------------------------------


if flags.plot_4Nico_c == 1
...
% get land fraction exposed to heatwaves under 1.5°, 2.0° and NDC tarjectories
[landfrac_peryear_OS  , ~, ~] = mf_exposure_mmm(extremes, {isimip.extreme}, ind_gmt, ages, age_ref, landfrac_peryear_perregion_OS  , [], RCP2GMT_maxdiff_OS  , RCP2GMT_maxdiff_threshold);
[landfrac_peryear_noOS, ~, ~] = mf_exposure_mmm(extremes, {isimip.extreme}, ind_gmt, ages, age_ref, landfrac_peryear_perregion_noOS, [], RCP2GMT_maxdiff_noOS, RCP2GMT_maxdiff_threshold);
...
% get time series and apply smoothing - panel a
landfrac_OS_plot   = smooth(squeeze(landfrac_peryear_OS(  ind_extreme, ind_region, :))) .* 100;
landfrac_noOS_plot = smooth(squeeze(landfrac_peryear_noOS(ind_extreme, ind_region, :))) .* 100;
...
% get associated Exposure Multiplication Factors (EMF) - panel c
EMF_plot_OS   = squeeze(EMF_perregion_OS(  ind_extreme, ind_region, :));
EMF_plot_noOS = squeeze(EMF_perregion_noOS(ind_extreme, ind_region, :));


% get number of extreme events for bars - panel c
exposure_bars_OS = [exposure_plot_OS(ages==age_ref_plot) exposure_plot_noOS(ages==age_ref_plot) ; ...
                    exposure_plot_OS(ages==age_young   ) exposure_plot_noOS(ages==age_young   )      ];


% define colors
color_noOS = [102 104 177] ./ 256;
color_OS   = [177 102 103] ./ 256;
...
% plot eulerian heatwaves
h(3) = plot(years_SR15(1:end-4), landfrac_OS_plot(  1:end-4) , 'color', color_OS  , 'linewidth', 2); hold on;
h(2) = plot(years_SR15(1:end-4), landfrac_noOS_plot(1:end-4) , 'color', color_noOS, 'linewidth', 2); hold on;
plot(years_SR15(years_SR15<year_ref), landfrac_OS_plot(years_SR15<year_ref), 'color', colors(28,:), 'linewidth', 2); hold on;
set(gca, 'Fontsize', 13, 'Fontweight', 'Bold', 'Xcolor', boxcolor, 'Ycolor', boxcolor, 'box', 'off');
set(gca, 'xtick', (1960:20:2100));
...
% text(years_SR15(end-4), landfrac_OS_plot(end-4)   - 0.2, ' overshoot'   , 'color', color_OS  , 'Fontsize', 11, 'Fontweight', 'Bold', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'middle')
% text(years_SR15(end-4), landfrac_noOS_plot(end-4) + 0.2, ' no overshoot', 'color', color_noOS, 'Fontsize', 11, 'Fontweight', 'Bold', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'middle')
legend(h(3:-1:2), 'overshoot', 'no overshoot', 'location', 'Northwest');
set(legend, 'box', 'off', 'Fontweight', 'Bold', 'Fontsize', 14, 'textcolor', axcolor);


% add title
ylims = ylim; % get y-axis limits
text(years_SR15(1), ylims(2) + ylims(2)*0.01, 'a','ver','bottom','hor','left','Fontsize', 14, 'Fontweight', 'bold', 'color', boxcolor)
...
cats = categorical({num2str(age_ref_plot), num2str(age_young)});
cats = reordercats(cats,{num2str(age_ref_plot), num2str(age_young)}); 
ba = bar(cats, exposure_bars_OS, barwidth, 'EdgeColor', 'none'); hold on;
ba(1).FaceColor = color_OS;
ba(2).FaceColor = color_noOS;
set(gca, 'Fontsize', 13, 'Fontweight', 'Bold', 'Xcolor', boxcolor, 'Ycolor', boxcolor, 'box', 'off');
xlabel('Age of person in 2020', 'Fontsize', 14, 'Fontweight', 'Bold'); 
ylabel('Life-accumulated heatwave exposure [-]', 'Fontsize', 14, 'Fontweight', 'Bold'); 
...
% add title
ylims = ylim; % get y-axis limits
text(xlims(1), ylims(2) + ylims(2)*0.01, 'b','ver','bottom','hor','left','Fontsize', 14, 'Fontweight', 'bold', 'color', boxcolor)
...
h(5) = plot(0.1, ymax, 'w'); hold on;                                                                    % dummy data to have y-axis until end of the 'boxplots'
set(gca, 'XDir','reverse', 'Fontsize', 13, 'Fontweight', 'Bold', 'Xcolor', boxcolor, 'Ycolor', boxcolor, 'box', 'off');
xlabel('Age of person in 2020', 'Fontsize', 14, 'Fontweight', 'Bold'); 
ylabel('Life-accumulated heatwave exposure [-]', 'Fontsize', 14, 'Fontweight', 'Bold'); 
...
% add title
ylims = ylim; % get y-axis limits
text(ages(1), ylims(2) + ylims(2)*0.01, ['c' '   ' extremes_legend{ind_extreme} ' exposure - '   regions.name{ind_region}],'ver','bottom','hor','left','Fontsize', 14, 'Fontweight', 'bold', 'color', boxcolor)
...
% plot 'boxplots': rectangle and horizontal line
rectangle('Position', [1, exposure_plot_q25_noOS(end), 3, exposure_plot_q75_noOS(end) - exposure_plot_q25_noOS(end)], 'FaceColor', [color_noOS 0.5], 'EdgeColor', 'none', 'LineWidth', 3); hold on; % +- 1 std
rectangle('Position', [5, exposure_plot_q25_OS(  end), 3, exposure_plot_q75_OS(  end) - exposure_plot_q25_OS(  end)], 'FaceColor', [color_OS   0.5], 'EdgeColor', 'none', 'LineWidth', 3); hold on;
plot([1 4 ], [exposure_plot_noOS(end) exposure_plot_noOS(end)], '-', 'linewidth', 3, 'color', color_noOS); hold on;
plot([5 8 ], [exposure_plot_OS(  end) exposure_plot_OS(  end)], '-', 'linewidth', 3, 'color', color_OS  ); hold on;


% Add labels
text(2 , max(0, exposure_plot_q25_noOS(end)), 'no overshoot  ', 'color', color_noOS, 'Fontsize', 14, 'Fontweight', 'Bold', 'Rotation', 90, 'HorizontalAlignment', 'right', 'VerticalAlignment', 'middle')
text(6 , max(0, exposure_plot_q25_OS(end))  , 'overshoot  '   , 'color', color_OS  , 'Fontsize', 14, 'Fontweight', 'Bold', 'Rotation', 90, 'HorizontalAlignment', 'right', 'VerticalAlignment', 'middle')
...
% save figure
export_fig('figures/for_nico/for_nico_conceptual_newlaptop.png', '-transparent');
...
% define panel letters for region plots
panelletters_4nico = {'b', 'c', 'g', 'd', 'd', 'e', 'e', 'f', 'g', 'h', 'f', 'a'};


% loop over regions
for ind_region= [3 5 6 11] %1:nregions
    ...
    for ind_extreme = 1:nextremes
        ...
        set(gca, 'XDir','reverse', 'Fontsize', 13, 'Fontweight', 'Bold', 'Xcolor', boxcolor, 'Ycolor', boxcolor, 'box', 'off');
        xlabel('Age of person in 2020', 'Fontsize', 14, 'Fontweight', 'Bold'); 
        ylabel('Life-accumulated exposure [-]', 'Fontsize', 14, 'Fontweight', 'Bold'); 


        % add title
        ylims = ylim; % get y-axis limits
        if ind_extreme == 5 % heatwaves
            text(ages(1), ylims(2) + ylims(2)*0.01, [panelletters_4nico{ind_region} '   ' extremes_legend{ind_extreme} ' exposure - '   regions.name{ind_region}],'ver','bottom','hor','left','Fontsize', 14, 'Fontweight', 'bold', 'color', boxcolor)
        else
            text(ages(1), ylims(2) + ylims(2)*0.01, [panelletters_regions{ind_region} '   ' extremes_legend{ind_extreme} ' exposure - '   regions.name{ind_region}],'ver','bottom','hor','left','Fontsize', 14, 'Fontweight', 'bold', 'color', boxcolor)
        end
...
% --------------------------------------------------------------------
% bar plot for Romania expert report
% --------------------------------------------------------------------


if flags.plot_4Romania == 1
...
% call plotting function
subplot(1,6,1); mf_plot_bars_Norway(valc_nr_children_facing_extra_heatwave_NeptunDeep_ref(   end-1, 1), valc_nr_children_facing_extra_heatwave_NeptunDeep(   end, 1), '2010-20', '1960-70', 'Heatwaves'    );
subplot(1,6,2); mf_plot_bars_Norway(valc_nr_children_facing_extra_drought_NeptunDeep_ref(    end-1, 1), valc_nr_children_facing_extra_drought_NeptunDeep(    end, 1), '2010-20', '1960-70', 'Droughts'     );
subplot(1,6,3); mf_plot_bars_Norway(valc_nr_children_facing_extra_cropfailure_NeptunDeep_ref(end-1, 1), valc_nr_children_facing_extra_cropfailure_NeptunDeep(end, 1), '2010-20', '1960-70', 'Crop failures');
subplot(1,6,4); mf_plot_bars_Norway(valc_nr_children_facing_extra_wildfire_NeptunDeep_ref(   end-1, 1), valc_nr_children_facing_extra_wildfire_NeptunDeep(   end, 1), '2010-20', '1960-70', 'Wildfires'    );
subplot(1,6,5); mf_plot_bars_Norway(valc_nr_children_facing_extra_tropcyclone_NeptunDeep_ref(end-1, 1), valc_nr_children_facing_extra_tropcyclone_NeptunDeep(end, 1), '2010-20', '1960-70', 'Trop cyclones');
subplot(1,6,6); mf_plot_bars_Norway(valc_nr_children_facing_extra_riverflood_NeptunDeep_ref( end-1, 1), valc_nr_children_facing_extra_riverflood_NeptunDeep( end, 1), '2010-20', '1960-70', 'River floods' );
hold off


% save figure
export_fig('figures/for_Romania/for_Romania_bar_chart_NeptunDeep.png', '-transparent');
    
end


% --------------------------------------------------------------------
% bar plot for UK first expert report
% --------------------------------------------------------------------


if flags.plot_4UKrep1 == 1
...
% call plotting function
subplot(1,6,1); mf_plot_bars_Norway(valc_nr_children_facing_extra_heatwave_JackdawRosebank_ref(   end-1, 1), valc_nr_children_facing_extra_heatwave_JackdawRosebank(   end, 1), '2010-20', '1960-70', 'Heatwaves'    );
subplot(1,6,2); mf_plot_bars_Norway(valc_nr_children_facing_extra_drought_JackdawRosebank_ref(    end-1, 1), valc_nr_children_facing_extra_drought_JackdawRosebank(    end, 1), '2010-20', '1960-70', 'Droughts'     );
subplot(1,6,3); mf_plot_bars_Norway(valc_nr_children_facing_extra_cropfailure_JackdawRosebank_ref(end-1, 1), valc_nr_children_facing_extra_cropfailure_JackdawRosebank(end, 1), '2010-20', '1960-70', 'Crop failures');
subplot(1,6,4); mf_plot_bars_Norway(valc_nr_children_facing_extra_wildfire_JackdawRosebank_ref(   end-1, 1), valc_nr_children_facing_extra_wildfire_JackdawRosebank(   end, 1), '2010-20', '1960-70', 'Wildfires'    );
subplot(1,6,5); mf_plot_bars_Norway(valc_nr_children_facing_extra_tropcyclone_JackdawRosebank_ref(end-1, 1), valc_nr_children_facing_extra_tropcyclone_JackdawRosebank(end, 1), '2010-20', '1960-70', 'Trop cyclones');
subplot(1,6,6); mf_plot_bars_Norway(valc_nr_children_facing_extra_riverflood_JackdawRosebank_ref( end-1, 1), valc_nr_children_facing_extra_riverflood_JackdawRosebank( end, 1), '2010-20', '1960-70', 'River floods' );
hold off


% save figure
export_fig('figures/for_UK/for_UK_bar_chart_Jackdaw.png', '-transparent');
...
% call plotting function
subplot(1,6,1); mf_plot_bars_Norway(valc_nr_children_facing_extra_heatwave_JackdawRosebank_ref(   end-1, 2), valc_nr_children_facing_extra_heatwave_JackdawRosebank(   end, 2), '2010-20', '1960-70', 'Heatwaves'    );
subplot(1,6,2); mf_plot_bars_Norway(valc_nr_children_facing_extra_drought_JackdawRosebank_ref(    end-1, 2), valc_nr_children_facing_extra_drought_JackdawRosebank(    end, 2), '2010-20', '1960-70', 'Droughts'     );
subplot(1,6,3); mf_plot_bars_Norway(valc_nr_children_facing_extra_cropfailure_JackdawRosebank_ref(end-1, 2), valc_nr_children_facing_extra_cropfailure_JackdawRosebank(end, 2), '2010-20', '1960-70', 'Crop failures');
subplot(1,6,4); mf_plot_bars_Norway(valc_nr_children_facing_extra_wildfire_JackdawRosebank_ref(   end-1, 2), valc_nr_children_facing_extra_wildfire_JackdawRosebank(   end, 2), '2010-20', '1960-70', 'Wildfires'    );
subplot(1,6,5); mf_plot_bars_Norway(valc_nr_children_facing_extra_tropcyclone_JackdawRosebank_ref(end-1, 2), valc_nr_children_facing_extra_tropcyclone_JackdawRosebank(end, 2), '2010-20', '1960-70', 'Trop cyclones');
subplot(1,6,6); mf_plot_bars_Norway(valc_nr_children_facing_extra_riverflood_JackdawRosebank_ref( end-1, 2), valc_nr_children_facing_extra_riverflood_JackdawRosebank( end, 2), '2010-20', '1960-70', 'River floods' );
hold off


% save figure
export_fig('figures/for_UK/for_UK_bar_chart_Rosebank.png', '-transparent');
...
% --------------------------------------------------------------------
% bar plot for UK second expert report
% --------------------------------------------------------------------


if flags.plot_4UKrep2 == 1
...
% call plotting function
subplot(1,6,1); mf_plot_bars_Norway(valc_nr_children_facing_extra_heatwave_Penguins_ref(   end-1, 1), valc_nr_children_facing_extra_heatwave_Penguins(   end, 1), '2010-20', '1960-70', 'Heatwaves'    );
subplot(1,6,2); mf_plot_bars_Norway(valc_nr_children_facing_extra_drought_Penguins_ref(    end-1, 1), valc_nr_children_facing_extra_drought_Penguins(    end, 1), '2010-20', '1960-70', 'Droughts'     );
subplot(1,6,3); mf_plot_bars_Norway(valc_nr_children_facing_extra_cropfailure_Penguins_ref(end-1, 1), valc_nr_children_facing_extra_cropfailure_Penguins(end, 1), '2010-20', '1960-70', 'Crop failures');
subplot(1,6,4); mf_plot_bars_Norway(valc_nr_children_facing_extra_wildfire_Penguins_ref(   end-1, 1), valc_nr_children_facing_extra_wildfire_Penguins(   end, 1), '2010-20', '1960-70', 'Wildfires'    );
subplot(1,6,5); mf_plot_bars_Norway(valc_nr_children_facing_extra_tropcyclone_Penguins_ref(end-1, 1), valc_nr_children_facing_extra_tropcyclone_Penguins(end, 1), '2010-20', '1960-70', 'Trop cyclones');
subplot(1,6,6); mf_plot_bars_Norway(valc_nr_children_facing_extra_riverflood_Penguins_ref( end-1, 1), valc_nr_children_facing_extra_riverflood_Penguins( end, 1), '2010-20', '1960-70', 'River floods' );
hold off


% save figure
export_fig('figures/for_UK/for_UK_bar_chart_Penguins.png', '-transparent');
...
% --------------------------------------------------------------------
% bar plot for ECtHR expert opinion
% --------------------------------------------------------------------


if flags.plot_4Norway_ECtHR == 1
...
% call plotting function
subplot(1,6,1); mf_plot_bars_Norway(valc_nr_children_facing_extra_heatwave_BarentsSea_ref(   end-1, 1:3), valc_nr_children_facing_extra_heatwave_BarentsSea(   end, 1:3), '2010-20', '1960-70', 'Heatwaves'    );
subplot(1,6,2); mf_plot_bars_Norway(valc_nr_children_facing_extra_drought_BarentsSea_ref(    end-1, 1:3), valc_nr_children_facing_extra_drought_BarentsSea(    end, 1:3), '2010-20', '1960-70', 'Droughts'     );
subplot(1,6,3); mf_plot_bars_Norway(valc_nr_children_facing_extra_cropfailure_BarentsSea_ref(end-1, 1:3), valc_nr_children_facing_extra_cropfailure_BarentsSea(end, 1:3), '2010-20', '1960-70', 'Crop failures');
subplot(1,6,4); mf_plot_bars_Norway(valc_nr_children_facing_extra_wildfire_BarentsSea_ref(   end-1, 1:3), valc_nr_children_facing_extra_wildfire_BarentsSea(   end, 1:3), '2010-20', '1960-70', 'Wildfires'    );
subplot(1,6,5); mf_plot_bars_Norway(valc_nr_children_facing_extra_tropcyclone_BarentsSea_ref(end-1, 1:3), valc_nr_children_facing_extra_tropcyclone_BarentsSea(end, 1:3), '2010-20', '1960-70', 'Trop cyclones');
subplot(1,6,6); mf_plot_bars_Norway(valc_nr_children_facing_extra_riverflood_BarentsSea_ref( end-1, 1:3), valc_nr_children_facing_extra_riverflood_BarentsSea( end, 1:3), '2010-20', '1960-70', 'River floods' );
hold off


% save figure
export_fig('figures/for_Norway_ECtHR/for_Norway_bar_chart_BarentsSea_South.png', '-transparent');
...
% call plotting function
subplot(1,6,1); mf_plot_bars_Norway(valc_nr_children_facing_extra_heatwave_BarentsSea_ref(   end-1, 4:6), valc_nr_children_facing_extra_heatwave_BarentsSea(   end, 4:6), '2010-20', '1960-70', 'Heatwaves'    );
subplot(1,6,2); mf_plot_bars_Norway(valc_nr_children_facing_extra_drought_BarentsSea_ref(    end-1, 4:6), valc_nr_children_facing_extra_drought_BarentsSea(    end, 4:6), '2010-20', '1960-70', 'Droughts'     );
subplot(1,6,3); mf_plot_bars_Norway(valc_nr_children_facing_extra_cropfailure_BarentsSea_ref(end-1, 4:6), valc_nr_children_facing_extra_cropfailure_BarentsSea(end, 4:6), '2010-20', '1960-70', 'Crop failures');
subplot(1,6,4); mf_plot_bars_Norway(valc_nr_children_facing_extra_wildfire_BarentsSea_ref(   end-1, 4:6), valc_nr_children_facing_extra_wildfire_BarentsSea(   end, 4:6), '2010-20', '1960-70', 'Wildfires'    );
subplot(1,6,5); mf_plot_bars_Norway(valc_nr_children_facing_extra_tropcyclone_BarentsSea_ref(end-1, 4:6), valc_nr_children_facing_extra_tropcyclone_BarentsSea(end, 4:6), '2010-20', '1960-70', 'Trop cyclones');
subplot(1,6,6); mf_plot_bars_Norway(valc_nr_children_facing_extra_riverflood_BarentsSea_ref( end-1, 4:6), valc_nr_children_facing_extra_riverflood_BarentsSea( end, 4:6), '2010-20', '1960-70', 'River floods' );
hold off


% save figure
export_fig('figures/for_Norway_ECtHR/for_Norway_bar_chart_BarentsSea_SouthEast.png', '-transparent');
...
% --------------------------------------------------------------------
% bar plot for appeal testimony
% --------------------------------------------------------------------


if flags.plot_4Norway_appeal == 1
...
% call plotting function
subplot(1,6,1); mf_plot_bars_Norway(valc_nr_children_facing_extra_heatwave_ref(   end, 4), valc_nr_children_facing_extra_heatwave_tot(   end, 4), '2010-20', '1960-70', 'Heatwaves'    );
subplot(1,6,2); mf_plot_bars_Norway(valc_nr_children_facing_extra_drought_ref(    end, 4), valc_nr_children_facing_extra_drought_tot(    end, 4), '2010-20', '1960-70', 'Droughts'     );
subplot(1,6,3); mf_plot_bars_Norway(valc_nr_children_facing_extra_cropfailure_ref(end, 4), valc_nr_children_facing_extra_cropfailure_tot(end, 4), '2010-20', '1960-70', 'Crop failures');
subplot(1,6,4); mf_plot_bars_Norway(valc_nr_children_facing_extra_wildfire_ref(   end, 4), valc_nr_children_facing_extra_wildfire_tot(   end, 4), '2010-20', '1960-70', 'Wildfires'    );
subplot(1,6,5); mf_plot_bars_Norway(valc_nr_children_facing_extra_tropcyclone_ref(end, 4), valc_nr_children_facing_extra_tropcyclone_tot(end, 4), '2010-20', '1960-70', 'Trop cyclones');
subplot(1,6,6); mf_plot_bars_Norway(valc_nr_children_facing_extra_riverflood_ref( end, 4), valc_nr_children_facing_extra_riverflood_tot( end, 4), '2010-20', '1960-70', 'River floods' );
hold off


% save figure
export_fig('figures/for_Norway_appeal/for_Norway_bar_chart_tot.png', '-transparent');
...
% % %     avoidance_map_young2ref(i).perextreme = (exposure_map_NDC(i).perextreme - exposure_map_15(i).perextreme) ./ exposure_map_NDC(i).perextreme .* 100;
% % % 
% % %     % young2ref EMF map - 1.5°C - per extreme
...
for ind_country = 1:ncountries
    ...
    % add exposure multiplication factors (EMF)
    for i=1:min(ceil(max(max(EMF_country_plot_rcp26, EMF_country_plot_rcp60))), 50)
...
for ind_country = 1:ncountries
    ...
    % add exposure multiplication factors (EMF)
    for i=1:min(ceil(max(EMF_country_plot_rcp60)), 50)
        text(4, i .* exposure_country_plot_rcp60(1),['\times' num2str(i)], 'Fontsize', 13, 'Fontweight', 'Bold', 'Color', axcolor, 'VerticalAlignment', 'middle')
    end
    hold off;
...
for ind_country = 1:ncountries
    ...
    % add exposure multiplication factors (EMF)
    for i=1:min(ceil(max(EMF_country_plot_NDC)), 50)
...
for ind_region = 1:nregions
    ...
    % add exposure multiplication factors (EMF)
    for i=1:min(ceil(max(max(EMF_region_plot_rcp26, EMF_region_plot_rcp60))), 50)
...
for ind_region = 1:nregions
    ...
    % add exposure multiplication factors (EMF)
    for i=1:min(ceil(max(EMF_region_plot_rcp60)), 50)
        text(4, i .* exposure_region_plot_rcp60(1),['\times' num2str(i)], 'Fontsize', 13, 'Fontweight', 'Bold', 'Color', axcolor, 'VerticalAlignment', 'middle')
    end
    hold off;
...
% % % 
% % %     % add exposure multiplication factors (EMF)
% % %     for i=1:min(ceil(max(EMF_perregion_plot_NDC)), 50)
...
% --------------------------------------------------------------------
% compare old and new life expectancy data
% --------------------------------------------------------------------


if flags.plot_LE0vs5 == 1



% loop over regions
for ind_region = [3 5 6 11 12]

    % visualisation
    figure
    set(gcf, 'color', 'w');
    plot(birth_years, regions.life_expectancy_0{ind_region}, 'color', 'r', 'linewidth', 3); hold on;
    plot(birth_years, regions.life_expectancy_5{ind_region}, 'color', 'b', 'linewidth', 3); hold on;
    title(regions.name{ind_region}, 'color', axcolor)
    set(gca, 'Fontsize', 15, 'Fontweight', 'Bold', 'Xcolor', axcolor, 'Ycolor', axcolor);
    xlabel('Birth year', 'Fontsize', 15, 'Fontweight', 'Bold'); 
    ylabel('Life expectancy at birth', 'Fontsize', 15, 'Fontweight', 'Bold'); 
    legend('period LE at birth (old; world bank)', 'cohort LE at birth excl. infant mortality (new; UN WPP +5yr +6yr)', 'location', 'southeast');
    set(legend, 'box', 'off', 'Fontweight', 'Bold', 'Fontsize', 9, 'textcolor', axcolor);

   
    % save figure
    export_fig(['figures/life_expectancy/life_expectancy_0vs5_region_' regions.name{ind_region} '.png'], '-transparent');
...
% % %     figure;
% % %     set(gcf, 'color', 'w');
% % %     plot(birth_years, countries.life_expectancy_0{ind_country}, 'color', 'r', 'linewidth', 3); hold on;
% % %     plot(birth_years, countries.life_expectancy_5{ind_country}, 'color', 'b', 'linewidth', 3); hold on;
% % %     title(countries.name{ind_country}, 'color', axcolor)
% % %     set(gca, 'Fontsize', 15, 'Fontweight', 'Bold', 'Xcolor', axcolor, 'Ycolor', axcolor);
% % %     xlabel('Birth year', 'Fontsize', 15, 'Fontweight', 'Bold'); 
% % %     ylabel('Life expectancy at birth', 'Fontsize', 15, 'Fontweight', 'Bold'); 
...
% % % 
% % %     % save figure
% % %     export_fig(['figures/life_expectancy/life_expectancy_0vs5_country_' countries.name{ind_country} '.png'], '-transparent');
% % %    
% % %     % clean up
% % %     close all
% % % 
...
for i=1:nruns
    ...
    % plot data
    if max(RCP2GMT_diff_15  ) <= RCP2GMT_maxdiff_threshold
        plot(years_SR15, isimip(i).years(ind_RCP2GMT_15) , 'color', 'r', 'linewidth', 1); hold on;
    end
    if max(RCP2GMT_diff_20  ) <= RCP2GMT_maxdiff_threshold
        plot(years_SR15, isimip(i).years(ind_RCP2GMT_20) , 'color', 'g', 'linewidth', 1); hold on;
    end
    if max(RCP2GMT_diff_NDC ) <= RCP2GMT_maxdiff_threshold
        plot(years_SR15, isimip(i).years(ind_RCP2GMT_NDC), 'color', 'b', 'linewidth', 1); hold on;
    end 
    

end
title('RCP versus SR1.5 years', 'color', axcolor)
set(gca, 'Fontsize', 15, 'Fontweight', 'Bold', 'Xcolor', axcolor, 'Ycolor', axcolor);
xlabel('year in SR1.5 scenario', 'Fontsize', 15, 'Fontweight', 'Bold'); 
ylabel('year in RCP scenario', 'Fontsize', 15, 'Fontweight', 'Bold'); 
legend('1.5°C', '2.0°C', 'Current pledges', 'location', 'southeast');
set(legend, 'box', 'off', 'Fontweight', 'Bold', 'Fontsize', 9, 'textcolor', axcolor);


% save figure
export_fig('figures/years_stabilisation.png', '-transparent');
