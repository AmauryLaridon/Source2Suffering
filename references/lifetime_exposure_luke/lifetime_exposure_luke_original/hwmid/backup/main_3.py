...
if __name__ == '__main__':
    ...
    import settings_3
    gcms, obs_types, pdir, cdir, lat_chunk, lon_chunk, time_chunk = settings_3.init()
    
    #%% ----------------------------------------------------------------
    # read in daily pic and annual max pic
    # ----------------------------------------------------------------

    from load_manip_3 import *
    ...
    #%% ----------------------------------------------------------------
    # retrieve 25th, 75th and 90th quantiles
    # ----------------------------------------------------------------

    ds_qntls = hwmid_qntls(
        ds_pic_daily,
        ds_pic_ann_max,
        gcms,
    )
