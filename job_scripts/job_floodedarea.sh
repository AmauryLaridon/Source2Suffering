...
#SBATCH --job-name=s2s_floodedarea
#SBATCH --ntasks=2
#SBATCH --mem=160G
...
output_file="/data/brussel/vo/000/bvo00012/vsc11137/source2suffering/output/job_output/out_s2s_floodedarea_${timestamp}"
error_file="/data/brussel/vo/000/bvo00012/vsc11137/source2suffering/output/job_error/err_s2s_floodedarea_${timestamp}"
