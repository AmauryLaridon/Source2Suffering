...
if Source2Suffering:
    ...
    reference_pulse = 1                 # 0: do not produce reports for the reference pulse of 1 GtC 
                                        # 1: produce reports for the reference pulse of 1 GtC 
    ...
    if reference_pulse:
        ...
        print("Selected regions:", region_names)
