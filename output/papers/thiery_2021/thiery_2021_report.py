# ---------------------------------------------------------------------------------------------#
# Functions to compute and print the different reports needed in the Thiery et al.(2021) paper #
# ---------------------------------------------------------------------------------------------#
...
print("Framework to reproduce the reports from Thiery et al. (2021) not yet developped in python.")
